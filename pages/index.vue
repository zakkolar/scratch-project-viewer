<template>
      <div class="center lh-copy f4-l f5 main">
        ...
        <url-box><span class="gray">https://scratch.mit.edu/projects/</span><debounce-input element="input" type="text" v-model="projectID" placeholder="Project ID" :size="projectID.length || 'Project ID'.length" class="code bg-transparent ba b--black-30 bt-0 bl-0 br-0 b--dashed"></debounce-input><span class="gray">/</span></url-box>
        ...
        <p><a href="#" @click.prevent="showSettings = !showSettings">Customize display</a></p>

        <div v-if="showSettings">

          <h2 class="f2 mb1">Customize</h2>
...
export default {
  ...
  computed:{
    completeUrl(){
      ...
      return `${this.baseUrl}/view?project=${this.urlSafe(this.projectID)}${paramsString}`;
    }
  },
  head(){
    return {
